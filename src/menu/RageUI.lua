print("")
print("^1Author : Skaygox")
print("^4Discord : https://discord.gg/YTbv5WC9")
print("")
print("^4[Download] : https://github.com/Skaygox/Skay_Shops")
print("^4[YouTube] : https://www.youtube.com/channel/UCzbvcRX35fKkNNSxHYR8ctg")
print("")
